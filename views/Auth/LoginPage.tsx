      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="w-full bg-[#0052CC] text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/30 group">
              登录系统
